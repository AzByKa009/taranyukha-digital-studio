...
const translations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    "trust.subtitle": "Без посредников и скриптов. Я лично разбираюсь в задаче, продумываю решение и отвечаю за результат.",
    "trust.quote": "Мне важно понять ваш бизнес — иначе маркетинг не сработает",
    ...
    "trust.item_3_desc": "Цифры важнее отчётов",
