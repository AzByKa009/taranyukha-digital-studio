...
const translations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    // Hero - focused messaging
    "hero.badge": "Сайты и AI для бизнеса",
    "hero.title_1": "Делаю сайты",
    "hero.title_2": ", которые приносят заявки",
    "hero.subtitle": "Разрабатываю продающие сайты под услуги и внедряю AI-решения для автоматизации. Один исполнитель — без агентств и лишних звеньев.",
    "hero.cta_primary": "Обсудить задачу",
    "hero.cta_secondary": "Примеры работ",
    "hero.stat_years": "Года опыта",
    "hero.stat_projects": "Проектов",
    "hero.stat_ai": "AI в каждом",
    "hero.stat_response": "Ответ",
    "hero.how_i_work": "Как это работает",
    "hero.step_1_title": "Созвон",
    "hero.step_1_desc": "Обсуждаем задачу за 15 минут",
    "hero.step_2_title": "Предложение",
    "hero.step_2_desc": "Получаете план и стоимость",
    "hero.step_3_title": "Работа",
    "hero.step_3_desc": "Делаю — вы занимаетесь бизнесом",
    "hero.step_4_title": "Запуск",
    "hero.step_4_desc": "Сайт работает и приносит заявки",
    ...
    "trust.label": "Почему я",
    "trust.title": "Работаете ",
    "trust.title_accent": "напрямую со мной",
    "trust.subtitle": "Никаких менеджеров и посредников. Я лично веду каждый проект от первого звонка до запуска. Вы всегда знаете, кто отвечает за результат.",
    "trust.quote": "Напишите в Telegram — отвечу сам, без ботов и ассистентов",
    "trust.item_1_title": "Один исполнитель",
    "trust.item_1_desc": "Не агентство с текучкой. Я лично делаю и отвечаю за результат",
    "trust.item_2_title": "Понимаю бизнес",
    "trust.item_2_desc": "Не просто «красиво», а чтобы сайт приносил заявки",
    "trust.item_3_title": "Быстро и прозрачно",
    "trust.item_3_desc": "Сайт за 2-3 недели. Понятные сроки и стоимость",
    "trust.item_4_title": "Поддержка",
    "trust.item_4_desc": "Не бросаю после запуска. Помогаю развивать",
