      ...
      <div className="container py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-6 max-w-xs">
              {footer?.tagline || "AI & Digital Production. Создаю инновационные цифровые решения, которые трансформируют бизнес."}
            </p>
            {contact?.email && (
              <a
        ...
        <div className="mt-16 pt-8 border-t border-border/40 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-muted-foreground">
            {footer?.copyright || `© ${new Date().getFullYear()} Aleksey Taranukha. Все права защищены.`}
          </p>
