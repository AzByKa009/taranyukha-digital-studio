...
const About = () => {
  useSEO({
    title: "Обо мне — Алексей Тарануха | Маркетолог",
    description: "Алексей Тарануха — маркетолог с системным подходом. Упаковка бизнеса, продвижение, AI-автоматизация. Работаю напрямую, без посредников.",
    keywords: "маркетолог, упаковка бизнеса, продвижение, AI автоматизация, системный маркетинг",
  }, [personSchema]);

  const benefits = [
    "Работаю напрямую — без менеджеров и агентств",
    "Беру на себя маркетинг целиком, а не отдельные задачи",
    "Прозрачный процесс и понятные сроки",
    "Опыт в разных нишах — понимаю специфику бизнеса",
    "Считаю результат, а не количество действий",
  ...
  const expertise = [
    {
      icon: Rocket,
      title: "Упаковка",
      description: "Позиционирование, сайты, смыслы — чтобы клиент понял ценность сразу",
      image: expertiseAi,
    },
    {
      icon: Lightbulb,
      title: "Продвижение",
      description: "Трафик, который конвертируется в заявки, а не просто в охваты",
      image: expertiseProduction,
    },
    {
      icon: Target,
      title: "Автоматизация",
      description: "AI-боты, интеграции, воронки — чтобы система работала без вас",
      image: expertiseWeb,
    },
    {
      icon: Users,
      title: "Стратегия",
      description: "Аудит, приоритеты, план действий — понятно, с чего начать",
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="animate-fade-in-up">
              ...
              <p className="text-xl text-muted-foreground mb-6 leading-relaxed">
                Маркетолог. Помогаю бизнесу расти системно — через упаковку, 
                продвижение и автоматизацию.
              </p>
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                Работаю напрямую, без посредников. Беру на себя маркетинг целиком — 
                от стратегии до реализации. Вы занимаетесь бизнесом, я — результатом.
              </p>
        ...
        <div className="container">
          <div className="text-center mb-14">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Четыре направления, которые складываются в систему
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-8">
                Беру на себя маркетинг целиком — не отдельные задачи, а результат. 
                Вам не нужно координировать подрядчиков или разбираться в технологиях.
              </p>
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-10 leading-relaxed">
              Расскажите о задаче — разберёмся, как могу помочь.
            </p>
